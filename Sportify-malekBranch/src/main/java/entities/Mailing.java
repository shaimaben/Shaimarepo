...
public class Mailing {
        ...
        public static void sendEmail(String recipient, String subject, String body) {
            ...
            String senderEmail = "chaimachaimanourddin@gmail.com"; // email address
            String senderPassword = "3140001078624048"; // email password
    ...
    public static void sendEmailWithAttachment(String recipientEmail, String subject, Multipart multipart) {
        ...
        String senderEmail = "chaimachaimanourddin@gmail.com";
        String senderPassword = "3140001078624048";
